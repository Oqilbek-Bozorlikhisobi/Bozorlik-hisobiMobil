...
class AppColors {
  ...
  // Har safar build bo'lganda yangilash uchun
  ...
  // DINAMIK RANGLAR - endi AppColors.white avtomatik o'zgaradi!
  static Color get primaryColor => const Color.fromRGBO(6, 178, 182, 1);
  static Color get primaryColorOpacity => const Color(0xFFedf9f2);

  static Color get white => _isDark
      ? const Color(0xFF1E1E1E)  // dark mode da
      : const Color.fromRGBO(255, 255, 255, 1);  // light mode da
  ...
  static Color get greyText => _isDark
      ? const Color(0xFF808080)
      : const Color.fromRGBO(190, 190, 190, 1);
  ...
  static const whiteStatic = Color.fromRGBO(255, 255, 255, 1);
  static const backGroundStatic = Color.fromRGBO(249, 249, 249, 1);
  static const greyStatic = Color.fromRGBO(230, 230, 230, 1);
  static const greyTextStatic = Color.fromRGBO(190, 190, 190, 1);
  static const textPrimaryStatic = Color(0xFF191919);
...
final lightTheme = ThemeData(
  brightness: Brightness.light,
  useMaterial3: true,
  iconTheme: const IconThemeData(color: AppColors.primaryColorStatic),
  iconButtonTheme: IconButtonThemeData(
    style: IconButton.styleFrom(foregroundColor: AppColors.primaryColorStatic),
  ),
  colorScheme: const ColorScheme.light(
    primary: AppColors.primaryColorStatic,
    secondary: AppColors.primaryColorStatic,
    surface: AppColors.whiteStatic,
    error: Color(0xFFDC2626),
    onPrimary: AppColors.whiteStatic,
    onSurface: AppColors.textPrimaryStatic,
  ),
  textTheme: const TextTheme(
    bodySmall: TextStyle(
      fontSize: 12,
  ...
  appBarTheme: const AppBarTheme(
    centerTitle: false,
    surfaceTintColor: AppColors.whiteStatic,
    titleTextStyle: TextStyle(
      fontWeight: FontWeight.w600,
      fontSize: 22,
      color: AppColors.textPrimaryStatic,
    ),
    backgroundColor: AppColors.whiteStatic,
    foregroundColor: AppColors.textPrimaryStatic,
    iconTheme: IconThemeData(color: AppColors.textPrimaryStatic),
  ),
  primaryColor: AppColors.primaryColorStatic,
  scaffoldBackgroundColor: AppColors.whiteStatic,
  cardColor: AppColors.whiteStatic,
  dividerColor: AppColors.greyStatic,
);
...
// BONUS: Context extension ham qo'shamiz (ixtiyoriy)
extension ThemeExtension on BuildContext {
  bool get isDarkMode => Theme.of(this).brightness == Brightness.dark;

  Color get backgroundColor => isDarkMode
      ? AppColors.darkBackground
      : AppColors.backGroundStatic;
