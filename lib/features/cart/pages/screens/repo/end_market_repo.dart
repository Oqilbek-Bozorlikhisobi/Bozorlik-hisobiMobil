...
class EndMarketRepository {
  Future<Map<String, dynamic>> endMarket({
    ...
    final response = await requestHelper.patchWithAuth("/market/$marketId", {"location": location, "name": name, "marketTypeId": marketTypeId});
  ...
  Future<Map<String, dynamic>> history({
    ...
    try {
      final response = await requestHelper.postWithAuth("/history", {"marketId": marketId.toString()});
      return response;
    } catch (e) {
