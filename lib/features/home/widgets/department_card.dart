        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                height: 178,
                child:state.statusDepartment==Status.loading?LoadingWidget(): state.statusDepartment == Status.error
                    ? Padding(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            top: 20,
                            left: 20,
                            child: Text(department?.titleUz??"", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.black)),
                          ),
                          // Logo
