                          ...
                          ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                ...
                                //                   id: state.marketData?[index].id,
                                //                   createdAt: state.marketData?[index].createdAt,
                                //                   updatedAt: state.marketData?[index].updatedAt,
                                //                   name: state.marketData?[index].name,
                                //                   isAllBuy: state.marketData?[index].isAllBuy,
                                //                   users: state.marketData?[index].users,
                                //                   marketCreator: state.marketData?[index].marketCreator,
                                //                   pendingUsers: state.marketData?[index].pendingUsers,
                                //                   marketLists: state.marketData?[index].marketLists,
                                //                   totalPrice: state.marketData?[index].totalPrice,
                                //                   location: state.marketData?[index].location,
                                //                   marketType: state.marketData?[index].marketType,
                                //                   isCurrent: state.marketData?[index].isCurrent,
                                //                 ),
                                //               ),
                                //         ),
                                //       )
